...
class EquipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipe" do
    assert_difference("Equipe.count") do
      post equipes_url, params: { equipe: { nome: @equipe.nome, unidade_id: @equipe.unidade_id } }
    end
  ...
  test "should update equipe" do
    patch equipe_url(@equipe), params: { equipe: { nome: @equipe.nome, unidade_id: @equipe.unidade_id } }
